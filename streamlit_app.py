...
genai.configure(api_key="AIzaSyBjxwpObmBkgVEn-EpQnd_4fNtIxio5-m0")
...
st.sidebar.write("Made by Dakshaa")
st.sidebar.write("Powered by google gemini ai")
st.header("RoboBill")
st.subheader("Made by Dakshaa")
...
You will have to greet the user first. Make sure to keep the fonts uniform and give the items list in a point wise format.
